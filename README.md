...
>
> This repo omits `gradle/wrapper/gradle-wrapper.jar` because the PR environment
> rejects binary file diffs. Use an installed Gradle 8.14.3 (or `mise`) for local
> builds, and regenerate the wrapper JAR locally with `gradle wrapper` if needed.
